(function () {
  function createIndexI18n(ctx) {
    ...
    const I18N_MAP = [
      ...
      ['.nav-links li:nth-child(6) a', 'navPricing'],
      ['.nav-links li:nth-child(7) a', 'navBusiness'],
      ['#openLogin', 'signIn'],
      ['.nav-cta', 'getApp'],
      ...
      ['.hero-duvi-bubble', 'duviHello', true],
      ...
      ['.feat-grid .feat:nth-child(12) h3', 'f12t', true], ['.feat-grid .feat:nth-child(12) p', 'f12p'], ['.feat-grid .feat:nth-child(12) .feat-tag', 'f12g'],
      ['.feat-grid .feat:nth-child(13) h3', 'f13t', true], ['.feat-grid .feat:nth-child(13) p', 'f13p'], ['.feat-grid .feat:nth-child(13) .feat-tag', 'f13g'],
      ['.feat-grid .feat:nth-child(14) h3', 'f14t', true], ['.feat-grid .feat:nth-child(14) p', 'f14p'], ['.feat-grid .feat:nth-child(14) .feat-tag', 'f14g'],
      ['.feat-grid .feat:nth-child(15) h3', 'f15t', true], ['.feat-grid .feat:nth-child(15) p', 'f15p'], ['.feat-grid .feat:nth-child(15) .feat-tag', 'f15g'],
      ...
      ['.phone-screen > .p-page:nth-child(1) .lp-chiprow .lp-chip:nth-child(2)', 'grammar'],
      ['.phone-screen > .p-page:nth-child(1) .lp-chiprow .lp-chip:nth-child(3)', 'vocabulary'],
      ['.phone-screen > .p-page:nth-child(1) .lp-chiprow .lp-chip:nth-child(4)', 'speaking'],
      ...
      ['.phone-screen > .p-page:nth-child(1) > .lp-label:nth-child(4)', 'popularNow'],
      ['.phone-screen > .p-page:nth-child(1) > .p-card:nth-child(5) .p-title', 'videoGermanStories'],
      ['.phone-screen > .p-page:nth-child(1) > .p-card:nth-child(5) .p-meta', 'videoGermanMeta'],
      ['.phone-screen > .p-page:nth-child(1) > .p-card:nth-child(6) .p-title', 'videoEnglishClub'],
      ['.phone-screen > .p-page:nth-child(1) > .p-card:nth-child(6) .p-meta', 'videoEnglishMeta'],
    ...
    const LANDING_2026_MAP = [
      ...
      ['#faq .faq-list .faq-item:nth-child(1) .faq-cat', 'faqCatPricing'],
      ['#faq .faq-list .faq-item:nth-child(1) .faq-a', 'faq1A'],
      ['#faq .faq-list .faq-item:nth-child(2) .faq-question', 'faq2Q'],
      ['#faq .faq-list .faq-item:nth-child(2) .faq-cat', 'faqCatLearning'],
      ['#faq .faq-list .faq-item:nth-child(2) .faq-a', 'faq2A'],
      ['#faq .faq-list .faq-item:nth-child(3) .faq-question', 'faq3Q'],
      ['#faq .faq-list .faq-item:nth-child(3) .faq-cat', 'faqCatLevel'],
      ['#faq .faq-list .faq-item:nth-child(3) .faq-a', 'faq3A'],
      ['#faq .faq-list .faq-item:nth-child(4) .faq-question', 'faq4Q'],
      ['#faq .faq-list .faq-item:nth-child(4) .faq-cat', 'faqCatTeachers'],
      ['#faq .faq-list .faq-item:nth-child(4) .faq-a', 'faq4A'],
      ['#faq .faq-list .faq-item:nth-child(5) .faq-question', 'faq5Q'],
      ['#faq .faq-list .faq-item:nth-child(5) .faq-cat', 'faqCatDevices'],
      ['#faq .faq-list .faq-item:nth-child(5) .faq-a', 'faq5A'],
      ['#faq .faq-list .faq-item:nth-child(6) .faq-question', 'faq6Q'],
      ['#faq .faq-list .faq-item:nth-child(6) .faq-cat', 'faqCatPayments'],
      ['#faq .faq-list .faq-item:nth-child(6) .faq-a', 'faq6A'],
