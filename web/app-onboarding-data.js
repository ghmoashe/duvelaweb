...
(function () {
  var countryDirectory = [
    ...
    // Added because learners from these countries hit "Choose a country from
    // the list" on a valid country name. Keep the earlier alphabetical block
    // untouched to minimise the diff; ranked() and findCountry() both loop
    // the whole array regardless of order, so appending is safe.
    { country: 'Armenia', cities: ['Yerevan', 'Gyumri', 'Vanadzor'] },
    { country: 'Azerbaijan', cities: ['Baku', 'Ganja', 'Sumqayit'] },
    { country: 'Bangladesh', cities: ['Dhaka', 'Chittagong', 'Sylhet'] },
    { country: 'Belarus', cities: ['Minsk', 'Gomel', 'Vitebsk', 'Brest'] },
    { country: 'Bosnia and Herzegovina', cities: ['Sarajevo', 'Banja Luka', 'Mostar'] },
    ...
    { country: 'Estonia', cities: ['Tallinn', 'Tartu', 'Narva'] },
    { country: 'Ethiopia', cities: ['Addis Ababa', 'Dire Dawa'] },
    ...
    { country: 'Iraq', cities: ['Baghdad', 'Basra', 'Erbil', 'Mosul'] },
    { country: 'Israel', cities: ['Tel Aviv', 'Jerusalem', 'Haifa', 'Beersheba'] },
    ...
    { country: 'Kuwait', cities: ['Kuwait City', 'Salmiya'] },
    { country: 'Kyrgyzstan', cities: ['Bishkek', 'Osh'] },
    { country: 'Latvia', cities: ['Riga', 'Daugavpils', 'Liepaja'] },
    { country: 'Lithuania', cities: ['Vilnius', 'Kaunas', 'Klaipeda'] },
    { country: 'Malaysia', cities: ['Kuala Lumpur', 'George Town', 'Johor Bahru'] },
    { country: 'Moldova', cities: ['Chisinau', 'Balti', 'Tiraspol'] },
    ...
    { country: 'Philippines', cities: ['Manila', 'Cebu City', 'Davao'] },
    { country: 'Qatar', cities: ['Doha', 'Al Rayyan'] },
    { country: 'Russia', cities: ['Moscow', 'Saint Petersburg', 'Novosibirsk', 'Yekaterinburg', 'Kazan', 'Nizhny Novgorod'] },
    { country: 'Slovakia', cities: ['Bratislava', 'Kosice', 'Zilina'] },
    ...
    { country: 'Turkmenistan', cities: ['Ashgabat', 'Turkmenabat'] },
