...
const scripts = ['DUVELA EXAM - TELC DEUTSCH B2 - AUDIO SCRIPTS', 'Format: relative MP3 path | German transcript', ''];
...
fs.writeFileSync(path.join(audioDir, 'audio-scripts.txt'), `${scripts.join('\n')}\n`, 'utf8');
