...
const tests = [
  {
    ...
    write:{instructions:'Ihre Freundin Nina feiert am Samstag Geburtstag und hat Sie eingeladen. Antworten Sie ihr. Wählen Sie drei der vier Punkte und schreiben Sie etwa 40 Wörter.',points:['für die Einladung danken','sagen, ob Sie kommen','nach einem Geschenk fragen','jemanden mitbringen']},
  ...
  },
  {
    ...
    write:{instructions:'In Ihrer Wohnung funktioniert die Heizung nicht. Schreiben Sie an die Hausverwaltung. Wählen Sie drei der vier Punkte und schreiben Sie etwa 40 Wörter.',points:['Problem beschreiben','seit wann','um Reparatur bitten','möglicher Termin']},
  ...
  },
  {
    ...
    write:{instructions:'Sie können morgen nicht zur Arbeit kommen. Schreiben Sie Ihrer Chefin. Wählen Sie drei der vier Punkte und schreiben Sie etwa 40 Wörter.',points:['Grund nennen','Dauer der Abwesenheit','wichtige Aufgabe erwähnen','Vertretung vorschlagen']},
  ...
  },
  {
    ...
    write:{instructions:'Sie haben in einem Hotel übernachtet und etwas vergessen. Schreiben Sie dem Hotel. Wählen Sie drei der vier Punkte und schreiben Sie etwa 40 Wörter.',points:['Aufenthaltsdatum','Gegenstand beschreiben','Fundort vermuten','um Zusendung bitten']},
  ...
  },
  {
    ...
    write:{instructions:'Ihr Kind ist krank und kann morgen nicht zur Schule kommen. Schreiben Sie der Lehrerin. Wählen Sie drei der vier Punkte und schreiben Sie etwa 40 Wörter.',points:['Grund nennen','voraussichtliche Dauer','nach Aufgaben fragen','um Rückmeldung bitten']},
  ...
  return {
    ...
    sections: [
      ...
      { id:'schreiben', title:'Schreiben', durationMin:20, maxPoints:15, aiGraded:true, instructions:'Bearbeiten Sie beide Aufgaben.', parts:[
        ...
        { id:'s2', title:'Teil 2 – Brief oder E-Mail', type:'free-write', instructions:source.write.instructions, minWords:40, leitpunkte:source.write.points, rubric:{level:'A2',maxPoints:10,criteria:['Drei Inhaltspunkte verständlich bearbeitet','Passende Anrede und Schluss','Zusammenhängender Text','Etwa 40 Wörter']} }
      ]},
